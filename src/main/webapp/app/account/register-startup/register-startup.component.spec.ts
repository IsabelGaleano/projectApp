...
describe('RegisterComponent', () => {
  ...
  let comp: RegisterStartupComponent;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(RegisterStartupComponent, '')
      .compileComponents();
  }));
  ...
  it('should update success to true after creating an account', inject(
    [RegisterStartupService, TranslateService],
    fakeAsync((service: RegisterStartupService, mockTranslateService: TranslateService) => {
  ...
  it('should notify of user existence upon 400/login already in use', inject(
    ...
    fakeAsync((service: RegisterStartupService) => {
