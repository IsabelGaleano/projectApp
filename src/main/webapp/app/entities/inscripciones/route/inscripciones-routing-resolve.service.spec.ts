...
describe('Inscripciones routing resolve service', () => {
  ...
  let resultInscripciones: IInscripciones | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IInscripciones if id is not provided', () => {
      // GIVEN
      ...
      expect(resultInscripciones).toEqual(new Inscripciones());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Inscripciones })));
      mockActivatedRouteSnapshot.params = { id: 123 };
