...
describe('Notificaciones routing resolve service', () => {
  ...
  let resultNotificaciones: INotificaciones | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new INotificaciones if id is not provided', () => {
      // GIVEN
      ...
      expect(resultNotificaciones).toEqual(new Notificaciones());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Notificaciones })));
      mockActivatedRouteSnapshot.params = { id: 123 };
